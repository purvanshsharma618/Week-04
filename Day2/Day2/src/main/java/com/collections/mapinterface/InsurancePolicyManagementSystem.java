...
public class InsurancePolicyManagementSystem {
    public static void main(String[] args) {
        ...
        // Adding policies
        manager.addPolicy(new Policy("P01", "John Doe", LocalDate.now().plusDays(10), 5000));
        manager.addPolicy(new Policy("P02", "Alice Smith", LocalDate.now().plusDays(40), 6000));
        manager.addPolicy(new Policy("P03", "John Doe", LocalDate.now().plusDays(5), 7000));
        manager.addPolicy(new Policy("P04", "Bob Williams", LocalDate.now().minusDays(5), 5500));
