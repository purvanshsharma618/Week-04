package com.generics.resumescreeningapp;
...
// Step 4: Screening Pipeline with Wildcards
...
public class ResumeScreeningApp {
    public static void main(String[] args) {
        ...
        applicants.add(new SoftwareEngineer("Amol", 4));
        applicants.add(new DataScientist("Bhuvan", 6));
        applicants.add(new ProductManager("Vishnu", 8));
